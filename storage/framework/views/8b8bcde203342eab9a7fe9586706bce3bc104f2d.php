            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="admin/product/editproduct/<?php echo e($pro->proid); ?>" method="POST" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                                ...
                                <select class="form-control" name="category">
                                    ...
                                    <?php $__currentLoopData = $cate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option 
                                            ...
                                            <?php endif; ?>
                                         value="<?php echo e($ca->cateid); ?>"><?php echo e($ca->catename); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input style="margin: 4px 0 0 46px;" checked="checked" name="status" type="radio" value="1">On
                                <input style="margin: 4px 0 0 46px;" name="status" type="radio" value="0">Off
                            </div>
                            <div class="form-group">
